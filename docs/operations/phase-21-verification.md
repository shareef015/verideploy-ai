...
Live OpenAI calls are intentionally not required for deterministic CI. Phase 9 provider mapping remains separately contract-tested. Live PostgreSQL integration tests remain guarded by `TEST_POSTGRES_URL`.

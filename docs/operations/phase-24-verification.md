...
Live PostgreSQL integration tests still require `TEST_POSTGRES_URL`. Phase 24 does not add a database migration because `agent_runs_phase19` already provides the durable agent audit boundary.

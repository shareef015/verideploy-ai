...
|---|---:|---|
| Phase 80 cumulative regression | 700 passed / 0 failed | `evals/reports/phase80-release-candidate-benchmarks.json` |
...
| Phase 76 Hybrid Recall@5 | 1.0 | `evals/reports/phase76-rag-performance.json` |
| Phase 76 Hybrid MRR | 1.0 | Phase 76 report |
| Phase 77 aggregate path score | 1.0 | `evals/reports/phase77-agentic-orchestration.json` |
| Phase 78 clean traceability | 1.0 | `evals/reports/phase78-multimodal-integration.json` |
| Phase 79 critical operational gaps | 0 | `evals/reports/phase79-production-operations.json` |
| Phase 82 architecture nodes | 15 | `evals/reports/phase82-final-production-architecture.json` |
| Phase 82 production data-flow edges | 19 | Phase 82 report |
| Phase 83 evidence-backed skill claims | 14 | `evals/reports/phase83-ai-engineering-jd-mapping.json` |

...
- Modify: any doc/config that names these scripts (caught by the sweep: `docs/architecture/phase-66-*.md`, `docs/phase60-*.md`, `docs/architecture/phase-52-*.md`, `docs/handoff-opentelemetry.md`, `config/operations/readiness.json`, `config/monorepo/policy.json`, `generated/clients/python/verideploy_contracts.py` header comment)
...
**Files:**
- Modify: ~135 files under `docs/` (renamed: `docs/phase-NN-*.md`, `docs/architecture/phase-NN-*.md`, `docs/operations/phaseNN-*.md`, `docs/operations/phase-NN/*.md`, generated `docs/architecture/topology.mmd` / `data-flow.mmd`, `docs/recruiter/captures/*.png`/`.json` if phase-named)

"""Phase 65 Kafka event architecture outbox/inbox.
...
def upgrade():
    ...
    for table in ('event_outbox_phase65','event_inbox_phase65','event_replay_requests_phase65'):
...
def downgrade():
    op.drop_table('event_replay_requests_phase65'); op.drop_table('event_inbox_phase65'); op.drop_table('event_outbox_phase65')

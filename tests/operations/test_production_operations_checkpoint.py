...
def test_phase79_operational_review_has_no_critical_gaps():
    r=review_operational_readiness(ROOT); assert r.passed; assert r.critical_gaps==0; assert r.domains_checked>=10

def test_phase79_required_alerts_have_owner_and_runbook():
...
def test_phase79_kafka_ops_preserves_idempotent_replay_contract():
...
def test_phase79_backup_restore_evidence_is_present():
...
def test_phase79_incident_response_preserves_approval_audit_and_tenant_controls():
